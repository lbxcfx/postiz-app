...
export const CalendarContext = createContext({
  startDate: newDayjs().subtract(3, 'day').format('YYYY-MM-DD'),
  endDate: newDayjs().add(3, 'day').format('YYYY-MM-DD'),
...
function getDateRange(display: string, referenceDate?: string) {
  ...
  switch (display) {
    ...
    case 'week':
      return {
        startDate: date.subtract(3, 'day').format('YYYY-MM-DD'),
        endDate: date.add(3, 'day').format('YYYY-MM-DD'),
      };
    case 'month':
      return {
