...
项目新增爆款内容分析功能，详见 [`docs/爆款分析模块方案.md`](./爆款分析模块方案.md)。

核心组件：

| 组件 | 位置 | 说明 |
|------|------|------|
| 用户画像 API | `api/routers/user_profile.py` | 批量获取用户粉丝数（二次爬取） |
| 评分算法 | 前端 `viral-score.ts` | 三维度爆款评分（互动×粉丝×时间） |
| 设置面板 | 前端 `materials-viral-settings.component.tsx` | 用户可调阈值 |

---

*文档生成时间: 2025-12-18 | 爆款模块更新: 2026-02-15*
